...
const Signup = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (json.success){
            ...
            history.push("/");
            props.showAlert("Account create successfull", "success");
        }
        else{
            props.showAlert("invali creentials", "danger");
        }
    }
        ...
        <div>
            ...
            <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input type="cpassword" className="form-control" name="cpassword" onChange={onChange} minLength={5} required id="cpassword"  />
                </div>
